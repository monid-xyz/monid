...
ownerControlledFuses: AbiParameterToPrimitiveType<{"internalType":"uint16","name":"ownerControlledFuses","type":"uint16"}>
};
...
export async function makeCommitment(
  ...
  [
    ...
    params: [options.name, options.owner, options.duration, options.secret, options.resolver, options.data, options.reverseRecord, options.ownerControlledFuses]
  });
};
