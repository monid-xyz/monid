      ...
      {message.type === 'success' && (
        <Modal isOpen={isOpen} onClose={onClose} isCentered size={['full','full','2xl']} scrollBehavior="outside">
          ...
          <ModalContent bg={lightMode ? 'var(--white)' : 'var(--dark1)'}>
            <ModalHeader textAlign={'center'} display={'flex'} gap={2} justifyContent={'center'}><LinkIcon type={'RiCheckboxCircleFill'} color={'var(--base1)'} size={'32px'} /> {message.title}</ModalHeader>
            <ModalBody
              display={'flex'}
