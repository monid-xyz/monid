        ...
        <ModalContent bg={colorMode === 'dark' ? 'var(--dark1)' : 'var(--white)'}>
          ...
          <ModalBody>
            ...
            <Stack my={6} p={4} border={'1px solid #77777777'} rounded={'2xl'} gap={4}>
                ...
                <li ><strong>Earlier Access to Register on Mainnet: </strong><br/>By joining the MONID Early Adopter Program, you will gain priority access to register your MONID domain on mainnet.</li>
                <li ><strong>Utility on the Platform: </strong><br/>As an early adopter, you will have the privilege of utilizing the cutting-edge features and functionalities of MONID.</li>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID Identorian OAT</Text>
                <Text>- You Own at least one Ventory x MONID NFT</Text>
              </Stack>
            </Flex>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID Countdown Catalyst NFT</Text>
                <Text>- You Own the MONID Countdown Catalyst NFT</Text>
              </Stack>
            </Flex>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID Spring Burst NFT</Text>
                <Text>- You Own the MONID Spring Burst NFT</Text>
              </Stack>
            </Flex>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID Family OAT</Text>
                <Text>- You have Registered at least one MONID Domain</Text>
              </Stack>
            </Flex>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID Pioneer OAT</Text>
                <Text>- You Are a Zealy Member with atleast 195 xps</Text>
                <Text>- OR You Have Registered at least one MONID Domain before 2024 and at least one MONID Domain after 2024</Text>
              </Stack>
            </Flex>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID Maverick OAT</Text>
                
                <Text>- You Have Registered more than one MONID Domain before 2024 (at different dates) and at least one MONID Domain after 2024</Text>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID Earlier Adopter OAT</Text>
                <Text> - You Have Migrated Your MONID from old contract (before 2024) to the new contract </Text>
              </Stack>
            </Flex>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID Champion OAT</Text>
                
                <Text>- You Have Registered at least one MONID Domain before 2024 (at different dates) and at least one MONID Domain after 2024</Text>
            ...
            <Flex
              ...
              rounded={'lg'}>
                ...
                />
              <Stack gap={0}>
                <Text fontWeight={'bold'}>MONID GEEKS OAT (mainnet)</Text>
                
                <Text>- You Have Registered at least one MONID Domain on mainnet</Text>
                <Text>- AND You Have Completed your profile for at least one MONID Domain on mainnet</Text>
              </Stack>
            </Flex>
