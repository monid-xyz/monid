...
const terms: Terms = {
  ...
  InvestmentNFT: {
    ...
    fa: 'شما فرصتی خواهید داشت تا به ارتقای چشم انداز ما کمک کنید و در توسعه و رشد پلتفرم سهام دار شوید. شما فرصت خواهید داشت تا یک NFT سرمایه گذاری را خریداری و نگه دارید که شما را به یک بخش قابل توجه از توزیع توکن MON واجد شرایط می کند. کلیه 900 NFT در دسترس خواهند بود و هزینه برای هر NFT را می تواند 0.1 ETH تنظیم شود.'
  },
  UIUXDesigner: {
  ...
  description: {
    en: 'Claim Your OnChain Presence',
