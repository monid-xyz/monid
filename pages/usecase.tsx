...
const Usecase: NextPage = () => {
  ...
  return (
    ...
    <Head>
        ...
        <meta name="twitter:image" content={`${SITE_URL}/api/og?title=${title}&subtitle=${des}&image=${SITE_URL}logos/monid.png`} />
        <meta name="og:title" content={title} />
        <meta name="og:description" content={des} />
        <meta name="og:image" content={`${SITE_URL}/api/og?title=${title}&subtitle=${des}&image=${SITE_URL}logos/monid.png`} />
